...
void ActionManager::Diamond(int x, int y, int z, float acell){
    ...
    posX.push_back(acell / 4); posY.push_back(acell / 4); posZ.push_back(acell / 4); typePos.push_back(1);
    posX.push_back(acell * 3 / 4); posY.push_back(acell * 3 / 4); posZ.push_back(acell / 4); typePos.push_back(1);
    posX.push_back(acell / 4); posY.push_back(acell * 3 / 4); posZ.push_back(acell * 3 / 4); typePos.push_back(1);
    posX.push_back(acell * 3 / 4); posY.push_back(acell / 4); posZ.push_back(acell * 3 / 4); typePos.push_back(1);
    ...
    std::ofstream output;
    //output.open("/home/ovito/Desktop/Diamond.xyz");
    output.open("Diamond.xyz");
