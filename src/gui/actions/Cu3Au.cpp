...
void ActionManager::Cu3Au(int x, int y, int z, float acell){
    
    std::vector<float> posX, posY, posZ, typePos, result;
    posX.push_back(0); posY.push_back(0); posZ.push_back(0); typePos.push_back(1);
    posX.push_back(acell / 2); posY.push_back(acell / 2); posZ.push_back(0); typePos.push_back(2);
    posX.push_back(0); posY.push_back(acell / 2); posZ.push_back(acell / 2); typePos.push_back(2);
    posX.push_back(acell / 2); posY.push_back(0); posZ.push_back(acell / 2); typePos.push_back(2);
