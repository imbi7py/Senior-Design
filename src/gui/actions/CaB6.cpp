...
void ActionManager::CaB6(int x, int y, int z, float acell) {
   ...
   std::vector<float> posX, posY, posZ, typePos, result;
    ...
    posX.push_back(acell / 2); posY.push_back(acell / 2); posZ.push_back(acell / 4); typePos.push_back(2);
    posX.push_back(acell / 2); posY.push_back(acell / 2); posZ.push_back(acell * 3 / 4); typePos.push_back(2);
    posX.push_back(acell / 4); posY.push_back(acell / 2); posZ.push_back(acell / 2); typePos.push_back(2);
    posX.push_back(acell / 2); posY.push_back(acell / 4); posZ.push_back(acell / 2); typePos.push_back(2);
    posX.push_back(acell * 3 / 4); posY.push_back(acell / 2); posZ.push_back(acell / 2); typePos.push_back(2);
    posX.push_back(acell / 2); posY.push_back(acell / 4 * 3); posZ.push_back(acell / 2); typePos.push_back(2);
