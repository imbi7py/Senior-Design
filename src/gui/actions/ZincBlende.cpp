...
void ActionManager::ZincBlende(int x, int y, int z, float acell) {
   ...
   // diamond
   posX.push_back(acell*0.75); posY.push_back(acell*0.25); posZ.push_back(acell*0.75); typePos.push_back(2);
   posX.push_back(acell*0.25); posY.push_back(acell*0.75); posZ.push_back(acell*0.75); typePos.push_back(2);
   posX.push_back(acell*0.25); posY.push_back(acell*0.25); posZ.push_back(acell*0.25); typePos.push_back(2);
   posX.push_back(acell*0.75); posY.push_back(acell*0.75); posZ.push_back(acell*0.25); typePos.push_back(2);
